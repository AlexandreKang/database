...
$sql = "UPDATE Client SET phone = '$c_phone' WHERE client_id = '$c_client_id'";
...
<head>
    ...
    <title>Update client's phone number</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="style.css" />
    <script ></script>
</head>
<body>
    <form method="post" action="UpdateClientPhoneMain.php">
Client id : <input type="text" name="client_id" placeholder="Enter the client id whose updating his / her information" /><br />
Phone number: <input type="tel" name="phone" placeholder="Enter the client's new phone number"/><br />
