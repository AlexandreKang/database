...
$sql = "UPDATE Client SET email_address = '$c_email_address' WHERE client_id = '$c_client_id'";
...
<head>
    ...
    <title>Update client's email address</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="style.css" />
    <script ></script>
</head>
<body>
    <form method="post" action="UpdateClientEmailAddressMain.php">
Client id : <input type="text" name="client_id" placeholder="Enter the client id whose updating his / her information" /><br />
Email address : <input type="email" name="email_address" placeholder="Enter the client's new email address" /><br />
