...
$sql = "UPDATE Employee SET phone = '$e_phone' WHERE employee_id = '$e_employee_id'";
...
<head>
    ...
    <title>Update employee's phone</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="style.css" />
    <script ></script>
</head>
<body>
    <form method="post" action="UpdateEmployeePhoneMain.php">
Phone : <input type="tel" name="phone" placeholder="Enter the new phone of the employee" /><br />
