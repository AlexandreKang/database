...
$sql = "UPDATE Payroll SET pay_date = '$e_pay_date' WHERE employee_id = '$e_employee_id'";
...
<head>
    ...
    <title>Update employee's pay date</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="style.css" />
    <script ></script>
</head>
<body>
    <form method="post" action="UpdateEmployeePayDateMain.php">
Pay date : <input type="date" name="pay_date" placeholder="Enter the new pay date for the employee" /><br />
