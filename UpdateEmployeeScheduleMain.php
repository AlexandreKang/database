...
$sql = "UPDATE Human_Resources SET schedule = '$e_schedule' WHERE employee_id = '$e_employee_id'";
...
<head>
    ...
    <title>Update employee's schedule</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="style.css" />
    <script ></script>
</head>
<body>
    <form method="post" action="UpdateEmployeeScheduleMain.php">
Schedule : <input type="text" name="schedule" placeholder="Enter the new work schedule for the new employee" /><br />
