...
$sql = "UPDATE Employee SET start_date = '$e_start_date' WHERE employee_id = '$e_employee_id'";
...
<head>
    ...
    <title>Update employee's start date</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="style.css" />
    <script ></script>
</head>
<body>
    <form method="post" action="UpdateEmployeeStartDateMain.php">
Start date : <input type="date" name="start_date" placeholder="Enter the new start date of the employee" /><br />
