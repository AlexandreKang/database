...
$sql = "UPDATE Employee SET email_address = '$e_email_address' WHERE employee_id = '$e_employee_id'";
...
<head>
    ...
    <title>Update employee's email address</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="style.css" />
    <script ></script>
</head>
<body>
    <form method="post" action="UpdateEmployeeEmailAddressMain.php">
Email address : <input type="email" name="email_address" placeholder="Enter the employee's new email address" /><br />
