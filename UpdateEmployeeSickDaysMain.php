...
$sql = "UPDATE Human_Resources SET sick_days = '$e_sick_days' WHERE employee_id = '$e_employee_id'";
...
<head>
    ...
    <title>Update employee's number of sick days</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="style.css" />
    <script ></script>
</head>
<body>
    <form method="post" action="UpdateEmployeeSickDaysMain.php">
Sick days: <input type="number" min = "0" name="sick_days" placeholder="Enter the new number of sick days allowed for the employee" /><br />
