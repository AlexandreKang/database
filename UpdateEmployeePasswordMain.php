...
$sql = "UPDATE Employee SET password = '$e_password' WHERE employee_id = '$e_employee_id'";
...
<head>
    ...
    <title>Update employee's password</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="style.css" />
    <script ></script>
</head>
<body>
    <form method="post" action="UpdateEmployeePasswordMain.php">
Password : <input type="text" name="password" placeholder="Enter the new employee's password for his / her account" /><br />
