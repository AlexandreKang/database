...
$sql = "UPDATE Client SET address = '$c_address' WHERE client_id = '$c_client_id'";
...
<head>
    ...
    <title>Update client's address</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="style.css" />
    <script ></script>
</head>
<body>
    <form method="post" action="UpdateClientAddressMain.php">
Client id : <input type="text" name="client_id" placeholder="Enter the client id whose updating his / her information" /><br />
Address : <input type="text" name="address" placeholder="Enter the client's new address" /><br />
