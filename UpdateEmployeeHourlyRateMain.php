...
$sql = "UPDATE Payroll SET hourly_rate = '$e_hourly_rate' WHERE employee_id = '$e_employee_id'";
...
<head>
    ...
    <title>Update employee's hourly rate</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="style.css" />
    <script ></script>
</head>
<body>
    <form method="post" action="UpdateEmployeeHourlyRateMain.php">
Hourly rate : <input type="text" name="hourly_rate" placeholder="Enter the new hourly rate for the employee" /><br />
