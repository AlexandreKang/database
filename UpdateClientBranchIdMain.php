...
$sql = "UPDATE Client SET branch_id = '$c_branch_id' WHERE client_id = '$c_client_id'";
...
<head>
    ...
    <title>Update client's branch ID</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="style.css" />
    <script ></script>
</head>
<body>
    <form method="post" action="UpdateClientBranchIdMain.php">
