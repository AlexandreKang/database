...
if ($_SERVER["REQUEST_METHOD"] == "POST") {//Check it is coming from a form
        ...
        $sql2 = "INSERT Transaction (transaction_id, branch_id, client_id, account_number, amount, transaction_date, transaction_type) VALUES (NULL, '$c_branch_id', '$c_client_id', '$c_account_number', '$c_balance', '$c_transaction_date', 'Withdraw')";
...
<body>
    <form method="post" action="UpdateWithdrawAccountMain.php">
Account number : <input type="text" name="account_number" placeholder="Enter an account number to update the account" /><br />
Withdraw: <input type="number" min = "0" step="0.01" name="balance" placeholder="Enter the amount to withdraw from the client's account" /><br />
Client id : <input type="text" name="client_id" placeholder="Enter the client id whose doing the transaction" /><br />
<!-- Branch id : <input type="text" name="branch_id" placeholder="Enter the branch id where the transaction takes place" /><br /> -->
