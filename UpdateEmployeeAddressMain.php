...
$sql = "UPDATE Employee SET address = '$e_address' WHERE employee_id = '$e_employee_id'";
...
<head>
    ...
    <title>Update employee's address</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="style.css" />
    <script ></script>
</head>
<body>
    <form method="post" action="UpdateEmployeeAddressMain.php">
Address : <input type="text" name="address" placeholder="Enter the new employee address" /><br />
