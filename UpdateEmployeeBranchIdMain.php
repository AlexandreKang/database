...
$sql = "UPDATE Employee SET branch_id = '$e_branch_id' WHERE employee_id = '$e_employee_id'";
...
<head>
    ...
    <title>Update employee's branch ID</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="style.css" />
    <script ></script>
</head>
<body>
    <form method="post" action="UpdateEmployeeBranchIdMain.php">
Branch id : <input type="text" name="branch_id" placeholder="Enter the new branch id of the employee" /><br />
